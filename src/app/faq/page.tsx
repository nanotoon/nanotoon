...
const faqs = [
  ...
  { q: "Upload Guidelines & Limits", a: "To keep the site fast and the experience smooth for everyone, NANOTOON has a few simple upload rules: each individual image is capped at 10 MB, with a total limit of 150 MB per Series Chapter. All uploads are stored in high quality via Cloudflare R2. These limits are in place to ensure a lag-free experience for your readers, and we appreciate your support as we build this community together!" },
